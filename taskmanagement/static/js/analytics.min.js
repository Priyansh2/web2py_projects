(function umd(require) {
    ...
    6: [function(require, module, exports) {
        ...
        "./lib/evergage": 31,
        "./lib/extole": 32,
        "./lib/facebook-conversion-tracking": 33,
        "./lib/foxmetrics": 34,
        "./lib/frontleaf": 35,
        "./lib/fullstory": 36,
        "./lib/gauges": 37,
        "./lib/get-satisfaction": 38,
        "./lib/google-analytics": 39,
        "./lib/google-tag-manager": 40,
        "./lib/gosquared": 41,
        "./lib/heap": 42,
        "./lib/hellobar": 43,
        "./lib/hittail": 44,
        ...
        "./lib/uservoice": 82,
        "./lib/vero": 83,
        "./lib/visual-website-optimizer": 84,
        "./lib/webengage": 85,
        "./lib/woopra": 86,
        "./lib/yandex-metrica": 87
    }],
    8: [function(require, module, exports) {
        ...
        var has = Object.prototype.hasOwnProperty;
        var AdRoll = module.exports = integration("AdRoll").assumesPageview().global("__adroll_loaded").global("adroll_adv_id").global("adroll_pix_id").global("adroll_custom_data").option("advId", "").option("pixId", "").tag("http", '<script src="http://a.adroll.com/j/roundtrip.js">').tag("https", '<script src="https://s.adroll.com/j/roundtrip.js">').mapping("events");
    ...
    92: [function(require, module, exports) {
        ...
        var cases = [identity, Case.upper, Case.lower, Case.snake, Case.pascal, Case.camel, Case.constant, Case.title, Case.capital, Case.sentence];
    ...
    124: [function(require, module, exports) {
        ...
        "to-camel-case": 125,
        "to-capital-case": 126,
        "to-constant-case": 127,
        "to-dot-case": 128,
        "to-no-case": 121,
        "to-pascal-case": 129,
        "to-sentence-case": 130,
        "to-slug-case": 131,
        "to-snake-case": 132,
        "to-space-case": 133,
        "to-title-case": 134
    ...
    137: [function(require, module, exports) {
        module.exports = ["a", "an", "and", "as", "at", "but", "by", "en", "for", "from", "how", "if", "in", "neither", "nor", "of", "on", "only", "onto", "out", "or", "per", "so", "than", "that", "the", "to", "until", "up", "upon", "v", "v.", "versus", "vs", "vs.", "via", "when", "with", "without", "yet"]
    }, {}],
    9: [function(require, module, exports) {
        ...
        var each = require("each");
        var has = Object.prototype.hasOwnProperty;
        var AdWords = module.exports = integration("AdWords").option("conversionId", "").option("remarketing", false).tag('<script src="//www.googleadservices.com/pagead/conversion_async.js">').mapping("events");
    ...
    11: [function(require, module, exports) {
        ...
        var Amplitude = module.exports = integration("Amplitude").global("amplitude").option("apiKey", "").option("trackAllPages", false).option("trackNamedPages", true).option("trackCategorizedPages", true).tag('<script src="' + src + '">');
        Amplitude.prototype.initialize = function(page) {
            (function(h, a) {
                ...
                var c = ["init", "logEvent", "setUserId", "setUserProperties", "setVersionName", "setDomain", "setDeviceId", "setGlobalUserProperties"];
    ...
    12: [function(require, module, exports) {
        ...
        var Appcues = exports.Integration = integration("Appcues").assumesPageview().global("Appcues").global("AppcuesIdentity").option("appcuesId", "").option("userId", "").option("userEmail", "");
    ...
    13: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var is = require("is");
        var Atatus = module.exports = integration("Atatus").global("atatus").option("apiKey", "").tag('<script src="//www.atatus.com/atatus.js">');
    ...
    14: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var Autosend = module.exports = integration("Autosend").global("_autosend").option("appKey", "").tag('<script id="asnd-tracker" src="https://d2zjxodm1cz8d6.cloudfront.net/js/v1/autosend.js" data-auth-key="{{ appKey }}">');
    ...
    15: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var each = require("each");
        var Awesm = module.exports = integration("awe.sm").assumesPageview().global("AWESM").option("apiKey", "").tag('<script src="//widgets.awe.sm/v3/widgets.js?key={{ apiKey }}&async=true">').mapping("events");
    ...
    16: [function(require, module, exports) {
        ...
        var has = Object.prototype.hasOwnProperty;
        var noop = function() {};
        var Bing = module.exports = integration("Bing Ads").global("uetq").option("tagId", "").tag('<script src="//bat.bing.com/bat.js">');
    ...
    17: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var Blueshift = module.exports = integration("Blueshift").global("blueshift").global("_blueshiftid").option("apiKey", "").option("retarget", false).tag('<script src="https://cdn.getblueshift.com/blueshift.js">');
    ...
    18: [function(require, module, exports) {
        ...
        var each = require("each");
        var Bronto = module.exports = integration("Bronto").global("__bta").option("siteId", "").option("host", "").tag('<script src="//p.bm23.com/bta.js">');
    ...
    149: [function(require, module, exports) {
        ...
        Facade.prototype.context = Facade.prototype.options = function(integration) {
    ...
    19: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var tick = require("next-tick");
        var BugHerd = module.exports = integration("BugHerd").assumesPageview().global("BugHerdConfig").global("_bugHerd").option("apiKey", "").option("showFeedbackTab", true).tag('<script src="//www.bugherd.com/sidebarv2.js?apikey={{ apiKey }}">');
    ...
    20: [function(require, module, exports) {
        ...
        var Bugsnag = module.exports = integration("Bugsnag").global("Bugsnag").option("apiKey", "").tag('<script src="' + src + '">');
    ...
    21: [function(require, module, exports) {
        ...
        var defaults = require("defaults");
        var onBody = require("on-body");
        var Chartbeat = module.exports = integration("Chartbeat").assumesPageview().global("_sf_async_config").global("_sf_endpt").global("pSUPERFLY").option("domain", "").option("uid", null).tag('<script src="//static.chartbeat.com/js/chartbeat.js">');
    ...
    22: [function(require, module, exports) {
        ...
        var ChurnBee = module.exports = integration("ChurnBee").global("_cbq").global("ChurnBee").option("apiKey", "").tag('<script src="//api.churnbee.com/cb.js">').mapping("events");
    ...
    23: [function(require, module, exports) {
        ...
        ClickTale.prototype.initialize = function(page) {
            ...
            this.load({
                ...
                window.ClickTale(self.options.projectId, self.options.recordingRatio, self.options.partitionId);
                self.ready()
            })
        };
    ...
    25: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var useHttps = require("use-https");
        var Comscore = module.exports = integration("comScore").assumesPageview().global("_comscore").global("COMSCORE").option("c1", "2").option("c2", "").tag("http", '<script src="http://b.scorecardresearch.com/beacon.js">').tag("https", '<script src="https://sb.scorecardresearch.com/beacon.js">');
    ...
    26: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var CrazyEgg = module.exports = integration("Crazy Egg").assumesPageview().global("CE2").option("accountNumber", "").tag('<script src="//dnn506yrbagrg.cloudfront.net/pages/scripts/{{ path }}.js?{{ cache }}">');
    ...
    29: [function(require, module, exports) {
        ...
        var Drip = module.exports = integration("Drip").assumesPageview().global("_dc").global("_dcqi").global("_dcq").global("_dcs").option("account", "").tag('<script src="//tag.getdrip.com/{{ account }}.js">');
    ...
    31: [function(require, module, exports) {
        ...
        var Evergage = module.exports = integration("Evergage").assumesPageview().global("_aaq").option("account", "").option("dataset", "").tag('<script src="//cdn.evergage.com/beacon/{{ account }}/{{ dataset }}/scripts/evergage.min.js">');
    ...
    32: [function(require, module, exports) {
        ...
        var Extole = module.exports = integration("Extole").global("extole").option("clientId", "").mapping("events").tag("main", '<script src="//tags.extole.com/{{ clientId }}/core.js">');
    ...
    33: [function(require, module, exports) {
        ...
        var each = require("each");
        var has = Object.prototype.hasOwnProperty;
        var Facebook = module.exports = integration("Facebook Conversion Tracking").global("_fbq").option("currency", "USD").tag('<script src="//connect.facebook.net/en_US/fbds.js">').mapping("events");
    ...
    34: [function(require, module, exports) {
        ...
        var Track = require("facade").Track;
        var each = require("each");
        var FoxMetrics = module.exports = integration("FoxMetrics").assumesPageview().global("_fxm").option("appId", "").tag('<script src="//d35tca7vmefkrc.cloudfront.net/scripts/{{ appId }}.js">');
        ...
        FoxMetrics.prototype.page = function(page) {
            ...
            push("_fxm.pages.view", properties.title, name, category, properties.url, properties.referrer)
        };
        FoxMetrics.prototype.identify = function(identify) {
            var id = identify.userId();
            if (!id) return;
            push("_fxm.visitor.profile", id, identify.firstName(), identify.lastName(), identify.email(), identify.address(), undefined, undefined, identify.traits())
        };
        ...
        FoxMetrics.prototype.completedOrder = function(track) {
            var orderId = track.orderId();
            push("_fxm.ecommerce.order", orderId, track.subtotal(), track.shipping(), track.tax(), track.city(), track.state(), track.zip(), track.quantity());
        ...
        function ecommerce(event, track, arr) {
            push.apply(null, ["_fxm.ecommerce." + event, track.id() || track.sku(), track.name(), track.category()].concat(arr || []))
        }
    }, {
        "global-queue": 173,
        "analytics.js-integration": 88,
    ...
    35: [function(require, module, exports) {
        ...
        var when = require("when");
        var is = require("is");
        var Frontleaf = module.exports = integration("Frontleaf").global("_fl").global("_flBaseUrl").option("baseUrl", "https://api.frontleaf.com").option("token", "").option("stream", "").option("trackNamedPages", false).option("trackCategorizedPages", false).tag('<script id="_fl" src="{{ baseUrl }}/lib/tracker.js">');
    ...
    36: [function(require, module, exports) {
        ...
        FullStory.prototype.initialize = function() {
            ...
            (function(m, n, e, t, l, o, g, y) {
                ...
                g.setSessionVars = function(v) {
                    FS("session", v)
                };
                g.setPageVars = function(v) {
                    FS("page", v)
                };
                self.ready();
                self.load()
    ...
    38: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var onBody = require("on-body");
        var GetSatisfaction = module.exports = integration("Get Satisfaction").assumesPageview().global("GSFN").option("widgetId", "").tag('<script src="https://loader.engage.gsfn.us/loader.js">');
    ...
    39: [function(require, module, exports) {
        ...
        GA.prototype.pushEnhancedEcommerce = function(track) {
            ga("send", "event", track.category() || "EnhancedEcommerce", track.event(), {
                nonInteraction: 1
            })
        };
    ...
    40: [function(require, module, exports) {
        ...
        var integration = require("analytics.js-integration");
        var GTM = module.exports = integration("Google Tag Manager").assumesPageview().global("dataLayer").global("google_tag_manager").option("containerId", "").option("trackNamedPages", true).option("trackCategorizedPages", true).tag('<script src="//www.googletagmanager.com/gtm.js?id={{ containerId }}&l=dataLayer">');
    ...
    41: [function(require, module, exports) {
        ...
        var GoSquared = module.exports = integration("GoSquared").assumesPageview().global("_gs").option("siteToken", "").option("anonymizeIP", false).option("cookieDomain", null).option("useCookies", true).option("trackHash", false).option("trackLocal", false).option("trackParams", true).tag('<script src="//d1l6p2sc9645hc.cloudfront.net/tracker.js">');
    ...
    43: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var Hellobar = module.exports = integration("Hello Bar").assumesPageview().global("_hbq").option("apiKey", "").tag('<script src="//s3.amazonaws.com/scripts.hellobar.com/{{ apiKey }}.js">');
    ...
    44: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var is = require("is");
        var HitTail = module.exports = integration("HitTail").assumesPageview().global("htk").option("siteId", "").tag('<script src="//{{ siteId }}.hittail.com/mlt.js">');
    ...
    45: [function(require, module, exports) {
        ...
        var HubSpot = module.exports = integration("HubSpot").assumesPageview().global("_hsq").option("portalId", null).tag('<script id="hs-analytics" src="https://js.hs-analytics.net/analytics/{{ cache }}/{{ portalId }}.js">');
        HubSpot.prototype.initialize = function(page) {
            window._hsq = [];
            var cache = Math.ceil(new Date / 3e5) * 3e5;
            this.load({
                cache: cache
            }, this.ready)
        };
    ...
    46: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var alias = require("alias");
        var Improvely = module.exports = integration("Improvely").assumesPageview().global("_improvely").global("improvely").option("domain", "").option("projectId", null).tag('<script src="//{{ domain }}.iljmp.com/improvely.js">');
    ...
    47: [function(require, module, exports) {
        ...
        var is = require("is");
        var has = Object.prototype.hasOwnProperty;
        var InsideVault = module.exports = integration("InsideVault").global("_iva").option("clientId", "").option("domain", "").tag('<script src="//analytics.staticiv.com/iva.js">').mapping("events");
    ...
    49: [function(require, module, exports) {
        ...
        var when = require("when");
        var is = require("is");
        var Intercom = module.exports = integration("Intercom").assumesPageview().global("Intercom").option("activator", "#IntercomDefaultWidget").option("appId", "").option("inbox", false).tag('<script src="https://static.intercomcdn.com/intercom.v1.js">');
    ...
    51: [function(require, module, exports) {
        ...
        var is = require("is");
        var Kenshoo = module.exports = integration("Kenshoo").global("k_trackevent").option("cid", "").option("subdomain", "").option("events", []).tag('<script src="//{{ subdomain }}.xg4ken.com/media/getpx.php?cid={{ cid }}">');
        ...
        Kenshoo.prototype.track = function(track) {
            ...
            var params = ["id=" + this.options.cid, "type=conv", "val=" + revenue, "orderId=" + track.orderId(), "promoCode=" + track.coupon(), "valueCurrency=" + track.currency(), "GCID=", "kw=", "product="];
    ...
    52: [function(require, module, exports) {
        ...
        var each = require("each");
        var is = require("is");
        var KISSmetrics = module.exports = integration("KISSmetrics").assumesPageview().global("_kmq").global("KM").global("_kmil").option("apiKey", "").option("trackNamedPages", true).option("trackCategorizedPages", true).option("prefixProperties", true).tag("library", '<script src="//scripts.kissmetrics.com/{{ apiKey }}.2.js">');
        exports.isMobile = navigator.userAgent.match(/Android/i) || navigator.userAgent.match(/BlackBerry/i) || navigator.userAgent.match(/iPhone|iPod/i) || navigator.userAgent.match(/iPad/i) || navigator.userAgent.match(/Opera Mini/i) || navigator.userAgent.match(/IEMobile/i);
    ...
    53: [function(require, module, exports) {
        ...
        var Klaviyo = module.exports = integration("Klaviyo").assumesPageview().global("_learnq").option("apiKey", "").tag('<script src="//a.klaviyo.com/media/js/learnmarklet.js">');
    ...
    54: [function(require, module, exports) {
        ...
        var Identify = require("facade").Identify;
        var when = require("when");
        var LiveChat = module.exports = integration("LiveChat").assumesPageview().global("__lc").global("__lc_inited").global("LC_API").global("LC_Invite").option("group", 0).option("license", "").tag('<script src="//cdn.livechatinc.com/tracking.js">');
    ...
    55: [function(require, module, exports) {
        ...
        var Identify = require("facade").Identify;
        var useHttps = require("use-https");
        var LuckyOrange = module.exports = integration("Lucky Orange").assumesPageview().global("_loq").global("__wtw_watcher_added").global("__wtw_lucky_site_id").global("__wtw_lucky_is_segment_io").global("__wtw_custom_user_data").option("siteId", null).tag("http", '<script src="http://www.luckyorange.com/w.js?{{ cache }}">').tag("https", '<script src="https://ssl.luckyorange.com/w.js?{{ cache }}">');
        LuckyOrange.prototype.initialize = function(page) {
            ...
            var cache = Math.floor((new Date).getTime() / 6e4);
            var name = useHttps() ? "https" : "http";
            this.load(name, {
                cache: cache
            }, this.ready)
    ...
    56: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var alias = require("alias");
        var Lytics = module.exports = integration("Lytics").global("jstag").option("cid", "").option("cookie", "seerid").option("delay", 2e3).option("sessionTimeout", 1800).option("url", "//c.lytics.io").tag('<script src="//c.lytics.io/static/io.min.js">');
        var aliases = {
    ...
    58: [function(require, module, exports) {
        ...
        var when = require("when");
        var is = require("is");
        var Mojn = module.exports = integration("Mojn").option("customerCode", "").global("_mojnTrack").tag('<script src="https://track.idtargeting.com/{{ customerCode }}/track.js">');
    ...
    59: [function(require, module, exports) {
        ...
        var integration = require("analytics.js-integration");
        var each = require("each");
        var Mouseflow = module.exports = integration("Mouseflow").assumesPageview().global("mouseflow").global("_mfq").option("apiKey", "").option("mouseflowHtmlDelay", 0).tag('<script src="//cdn.mouseflow.com/projects/{{ apiKey }}.js">');
    ...
    60: [function(require, module, exports) {
        ...
        var each = require("each");
        var is = require("is");
        var MouseStats = module.exports = integration("MouseStats").assumesPageview().global("msaa").global("MouseStatsVisitorPlaybacks").option("accountNumber", "").tag("http", '<script src="http://www2.mousestats.com/js/{{ path }}.js?{{ cache }}">').tag("https", '<script src="https://ssl.mousestats.com/js/{{ path }}.js?{{ cache }}">');
    ...
    61: [function(require, module, exports) {
        ...
        var Navilytics = module.exports = integration("Navilytics").assumesPageview().global("__nls").option("memberId", "").option("projectId", "").tag('<script src="//www.navilytics.com/nls.js?mid={{ memberId }}&pid={{ projectId }}">');
    ...
    62: [function(require, module, exports) {
        ...
        var alias = require("alias");
        var Identify = require("facade").Identify;
        var Nudgespot = module.exports = integration("Nudgespot").assumesPageview().option("apiKey", "").global("nudgespot").tag('<script id="nudgespot" src="//cdn.nudgespot.com/nudgespot.js">');
    ...
    63: [function(require, module, exports) {
        ...
        var tick = require("next-tick");
        var Olark = module.exports = integration("Olark").assumesPageview().global("olark").option("identify", true).option("page", true).option("siteId", "").option("groupId", "").option("track", false);
    ...
    64: [function(require, module, exports) {
        ...
        var bind = require("bind");
        var each = require("each");
        var Optimizely = module.exports = integration("Optimizely").option("variations", true).option("trackNamedPages", true).option("trackCategorizedPages", true);
    ...
    65: [function(require, module, exports) {
        ...
        var PerfectAudience = module.exports = integration("Perfect Audience").assumesPageview().global("_pq").option("siteId", "").tag('<script src="//tag.perfectaudience.com/serve/{{ siteId }}.js">');
    ...
    68: [function(require, module, exports) {
        ...
        var alias = require("alias");
        var Preact = module.exports = integration("Preact").assumesPageview().global("_preactq").global("_lnq").option("projectCode", "").tag('<script src="//d2bbvl6dq48fa6.cloudfront.net/js/preact-4.1.min.js">');
    ...
    69: [function(require, module, exports) {
        ...
        var bind = require("bind");
        var when = require("when");
        var Qualaroo = module.exports = integration("Qualaroo").assumesPageview().global("_kiq").option("customerId", "").option("siteToken", "").option("track", false).tag('<script src="//s3.amazonaws.com/ki.js/{{ customerId }}/{{ siteToken }}.js">');
    ...
    70: [function(require, module, exports) {
        ...
        Quantcast.prototype.track = function(track) {
            ...
            var user = this.analytics.user();
            if (null != revenue) settings.revenue = revenue + "";
    ...
    71: [function(require, module, exports) {
        ...
        var extend = require("extend");
        var is = require("is");
        var RollbarIntegration = module.exports = integration("Rollbar").global("Rollbar").option("identify", true).option("accessToken", "").option("environment", "unknown").option("captureUncaught", true);
        RollbarIntegration.prototype.initialize = function(page) {
            ...
            (function(a, b) {
                function c(b) {
                    this.shimId = ++h, this.notifier = null, this.parentShim = b, this.logger = function() {}, a.console && void 0 === a.console.shimId && (this.logger = a.console.log)
                }

                function d(b, c, d) {
                    a._rollbarWrappedError && (d[4] || (d[4] = a._rollbarWrappedError), d[5] || (d[5] = a._rollbarWrappedError._rollbarContext), a._rollbarWrappedError = null), b.uncaughtError.apply(b, d), c && c.apply(a, d)
                }
                ...
                function g(a, b) {
                    return b = b || this.logger,
                        function() {
                            try {
                                return a.apply(this, arguments)
                            } catch (c) {
                                b("Rollbar internal error:", c)
                            }
                        }
                }
                var h = 0;
                c.init = function(a, b) {
                ...
                }, c.prototype.loadFull = function(a, b, c, d, e) {
                    var f = g(function() {
                            var a = b.createElement("script"),
                                e = b.getElementsByTagName("script")[0];
                            a.src = d.rollbarJsUrl, a.async = !c, a.onload = h, e.parentNode.insertBefore(a, e)
                        }, this.logger),
                        h = g(function() {
                            var b;
                            if (void 0 === a._rollbarPayloadQueue) {
                                var c, d, f, g;
                                for (b = new Error("rollbar.js did not load"); c = a._rollbarShimQueue.shift();)
                                    for (f = c.args, g = 0; g < f.length; ++g)
                                        if (d = f[g], "function" == typeof d) {
                                            d(b);
                                            break
                                        }
                            }
                    ...
                    g(function() {
                        c ? f() : a.addEventListener ? a.addEventListener("load", f, !1) : a.attachEvent("onload", f)
                    }, this.logger)()
                }, c.prototype.wrap = function(b, c) {
                    try {
                        var d;
                        if (d = "function" == typeof c ? c : function() {
                                return c || {}
                            }, "function" != typeof b) return b;
                        ...
                        if (!b._wrapped) {
                            b._wrapped = function() {
                                try {
                                    ...
                                    throw c._rollbarContext = d(), c._rollbarContext._wrappedSource = b.toString(), a._rollbarWrappedError = c, c
                                }
    ...
    73: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var when = require("when");
        var SatisMeter = module.exports = integration("SatisMeter").global("satismeter").option("token", "").tag('<script src="https://app.satismeter.com/satismeter.js">');
    ...
    74: [function(require, module, exports) {
        ...
        var Segment = exports = module.exports = integration("Segment.io").option("apiKey", "");
    ...
    75: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var is = require("is");
        var Sentry = module.exports = integration("Sentry").global("Raven").option("config", "").tag('<script src="//cdn.ravenjs.com/1.1.16/native/raven.min.js">');
    ...
    76: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var is = require("is");
        var SnapEngage = module.exports = integration("SnapEngage").assumesPageview().global("SnapABug").option("apiKey", "").tag('<script src="//commondatastorage.googleapis.com/code.snapengage.com/js/{{ apiKey }}.js">');
    ...
    77: [function(require, module, exports) {
        ...
        var bind = require("bind");
        var when = require("when");
        var Spinnakr = module.exports = integration("Spinnakr").assumesPageview().global("_spinnakr_site_id").global("_spinnakr").option("siteId", "").tag('<script src="//d3ojzyhbolvoi5.cloudfront.net/js/so.js">');
    ...
    79: [function(require, module, exports) {
        ...
        var alias = require("alias");
        var clone = require("clone");
        var Trakio = module.exports = integration("trak.io").assumesPageview().global("trak").option("token", "").option("trackNamedPages", true).option("trackCategorizedPages", true).tag('<script src="//d29p64779x43zo.cloudfront.net/v1/trak.io.min.js">');
        var optionsAliases = {
        ...
        Trakio.prototype.initialize = function(page) {
            ...
            window.trak.io.load = window.trak.io.load || function(e) {
                var r = function(e) {
                        return function() {
    ...
    80: [function(require, module, exports) {
        ...
        var each = require("each");
        var has = Object.prototype.hasOwnProperty;
        var TwitterAds = module.exports = integration("Twitter Ads").option("page", "").tag('<img src="//analytics.twitter.com/i/adsct?txn_id={{ pixelId }}&p_id=Twitter"/>').mapping("events");
    ...
    81: [function(require, module, exports) {
        ...
        var Identify = require("facade").Identify;
        var clone = require("clone");
        var Userlike = module.exports = integration("Userlike").assumesPageview().global("userlikeConfig").global("userlikeData").option("secretKey", "").tag('<script src="//userlike-cdn-widgets.s3-eu-west-1.amazonaws.com/{{ secretKey }}.js">');
        Userlike.prototype.initialize = function(page) {
            ...
            if (!window.userlikeData) window.userlikeData = {
                custom: {}
            };
    ...
    82: [function(require, module, exports) {
        ...
        UserVoice.prototype.initialize = function(page) {
            ...
            if (options.showWidget) {
                options.trigger ? push("addTrigger", options.trigger, opts) : push("addTrigger", opts)
            }
            this.load(this.ready)
        };
    ...
    83: [function(require, module, exports) {
        ...
        var objCase = require("obj-case");
        var Vero = module.exports = integration("Vero").global("_veroq").option("apiKey", "").tag('<script src="//d3qxef4rp70elm.cloudfront.net/m.js">');
    ...
    84: [function(require, module, exports) {
        ...
        var tick = require("next-tick");
        var each = require("each");
        var VWO = module.exports = integration("Visual Website Optimizer").option("replay", true);
    ...
    85: [function(require, module, exports) {
        var integration = require("analytics.js-integration");
        var useHttps = require("use-https");
        var WebEngage = module.exports = integration("WebEngage").assumesPageview().global("_weq").global("webengage").option("widgetVersion", "4.0").option("licenseCode", "").tag("http", '<script src="http://cdn.widgets.webengage.com/js/widget/webengage-min-v-4.0.js">').tag("https", '<script src="https://ssl.widgets.webengage.com/js/widget/webengage-min-v-4.0.js">');
    ...
    87: [function(require, module, exports) {
        ...
        var bind = require("bind");
        var when = require("when");
        var Yandex = module.exports = integration("Yandex Metrica").assumesPageview().global("yandex_metrika_callbacks").global("Ya").option("counterId", null).option("clickmap", false).option("webvisor", false).tag('<script src="//mc.yandex.ru/metrika/watch.js">');
    ...
    214: [function(require, module, exports) {
        ...
        function normalize(msg, list) {
            ...
            function integration(name) {
                return !!(~indexof(list, name) || "all" == name.toLowerCase() || ~indexof(lower, name.toLowerCase()))
            }
        }
    }, {
        debug: 201,
        "component/indexof": 116,
        defaults: 97,
        "component/map": 221,
        each: 4,
        is: 91
